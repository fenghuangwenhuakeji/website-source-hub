...
function initializeCharacterDeckSystem() {
    ...
    if (modal) {
        ...
        document.getElementById('add-relationship-btn').addEventListener('click', handleAddRelationship);
        document.getElementById('more-ai-actions').addEventListener('change', (e) => {
    ...
    // 每次选择后重置，以便可以重复选择同一个选项
    e.target.value = "";
});
        document.getElementById('timeline-scroll-left').addEventListener('click', () => scrollTimeline(-200));
        document.getElementById('timeline-scroll-right').addEventListener('click', () => scrollTimeline(200));
    }
