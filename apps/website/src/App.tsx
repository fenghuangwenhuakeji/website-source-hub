...
function RouteSkeleton() {
  return (
    <div className="min-h-screen bg-[var(--fh-bg)] pt-28">
      <div className="mx-auto max-w-6xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="glass-card p-8 sm:p-10">
          <div className="h-4 w-28 rounded-full bg-stone-200" />
          <div className="mt-5 h-10 w-2/3 rounded-full bg-stone-300" />
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {Array.from({ length: 3 }).map((_, index) => (
              <div key={index} className="rounded-[24px] border border-stone-200 bg-stone-50 p-6 shadow-sm">
                <div className="h-5 w-24 rounded-full bg-stone-200" />
                <div className="mt-4 h-6 w-3/4 rounded-full bg-stone-300" />
