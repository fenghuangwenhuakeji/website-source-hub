...
Modules.phoenix = {
    ...
    steps: [
        ...
        { title: '细纲定稿', icon: 'fa-diagram-project', desc: '从细纲提实体、规则、伏笔、关系并入图谱' },
            ...
            <div class="w-64 shrink-0 flex flex-col bg-[#111113] border-r border-white/5">
                ...
                <div class="p-4 border-t border-white/5 bg-[#0d0d0f] space-y-2">
                    <button class="btn w-full h-10 btn-primary font-bold" onclick="Modules.phoenix.next()">
                        ${this.step === 1 ? '<i class="fa-solid fa-atom mr-2"></i>准备同步' : (this.step === 2 ? '<i class="fa-solid fa-check mr-2"></i>确认同步' : '下一步 <i class="fa-solid fa-arrow-right ml-2"></i>')}
                    </button>
                ...
                <div class="flex-1 flex flex-col border-r border-white/5 min-w-0">
                    ...
                    <div class="px-5 pt-2 pb-1 shrink-0">
                        ...
                        <div class="grid grid-cols-6 gap-1">
                            <button class="btn btn-xs bg-white/5 text-dim hover:bg-accent/20 hover:text-accent border border-white/5" onclick="Modules.phoenix.continueGen()" title="从当前大纲末尾继续往下写"><i class="fa-solid fa-forward mr-0.5"></i>续写</button>
                    ...
                    <div class="px-5 pb-4 shrink-0">
                        ...
                        <div class="text-[9px] text-dim mt-1.5 text-center">先生成细纲；下一步会从细纲提实体并直接同步到世界引擎。</div>
                    </div>
                </div>
                <!-- Output Side -->
        ...
        return `
                    ...
                    <div id="ph-tab-preview" class="flex-1 flex flex-col min-h-0 ${t!=='preview'?'hidden':''}">
                        ...
                        <div class="flex items-center justify-between px-4 py-1 bg-black/20 border-b border-white/5 shrink-0">
                            <span class="text-[10px] text-dim font-mono" id="ph-outline-stats">${(this.data.outlineRaw||'').length} 字 · ${outlineStats.chapCount} 章</span>
                        ...
                        <div class="shrink-0 border-t border-white/5 bg-[#0a0a0c]">
                            ...
                            <div class="flex gap-1.5 px-4 pt-1.5 pb-0 flex-wrap">
                                ...
                                <button class="text-[9px] px-2 py-0.5 rounded bg-white/5 text-dim hover:bg-cyan-500/20 hover:text-cyan-400 border border-white/5 hover:border-cyan-500/30 transition" onclick="Modules.phoenix._inlineQuickAction('continue')" title="从光标或选中片段后继续写">➕ 续写</button>
                                ...
                                <span class="text-[8px] text-dim self-center ml-1">选中后改写；不选点续写会接在光标后</span>
                            </div>
