...
const BUILTIN_DESKTOP_APPS: DesktopAppDefinition[] = [
  ...
  },
  {
    id: 'longbook',
    title: '长篇创作',
    description: '打开长篇写作工作台，管理项目、章节、设定和世界观。',
    icon: 'BookOpen',
    color: '#8b5cf6',
    width: 1260,
    height: 840,
    kind: 'legacy',
    runtime: 'static-web',
    route: buildStaticAppRoute('longbook'),
    tags: ['imported', 'static-web', 'writing', 'longbook', 'novel'],
    ...createExperienceMetadata('writing', ['writing', 'novel', 'outline', 'chapter'], 'primary'),
  },
  {
    id: 'medium-short',
    title: '中短篇创作',
