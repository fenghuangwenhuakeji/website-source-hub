...
Modules.web_chat = {
    ...
    _poolApiToModel(api) {
        const providerMap = {
            ...
            gemini: ['Google Gemini', 'fa-gem', ['text', 'vision', 'long', 'json']],
            claude: ['Anthropic', 'fa-feather', ['text', 'vision', 'long', 'reasoning']],
            ...
            openrouter: ['OpenRouter', 'fa-route', ['text', 'vision', 'long', 'reasoning', 'json']]
        };
