                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="group cursor-pointer bg-[#0e0e12] rounded-xl border border-white/5 hover:border-green-500/30 p-5 transition-all col-span-2" onclick="Modules.world_engine._openNovelImportModal()";>
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div><div class="font-bold text-white">导入已有作品</div><div class="text-[9px] text-dim">外部续写 · AI解析</div></div>
                        </div>
                        <div class="text-[10px] text-gray-400 leading-relaxed">上传或粘贴已有小说文本，AI自动解析卷章结构、提取实体、同步到世界引擎，然后进入执笔台继续创作。</div>
                    </div>
                </div>
            </div>
