...
Modules.home = {
    ...
    _pathProfile(mode) {
        ...
        const map = {
            phoenix: {
                headline: '我要从零写一本',
                plain: '没有原稿，先定题材、主角欲望、阻力和代价。',
                input: '输入：题材/一句话脑洞',
                process: '系统：生成执行级细纲，再提实体、规则、伏笔',
                result: '产出：细纲 + 知识图谱 + 正文上下文',
                target: 'phoenix',
                targetLabel: '打开从零写',
                steps: ['开书', '细纲', '入图谱', '写正文']
            },
            import: {
                headline: '我要接着已有作品写',
                plain: '已有正文先保留，再按卷章拆成能续写的细纲。',
                input: '输入：已有正文/原稿',
                process: '系统：章节细分，补齐细纲，提实体/规则/伏笔/关系',
                result: '产出：原文章节 + 续写细纲 + 图谱上下文',
                target: 'world_engine',
                targetLabel: '打开导入续写',
                steps: ['导入正文', '章内细纲', '入图谱', '补续写']
            },
            fusion: {
                headline: '我要拆书融合出新书',
                plain: '拿两本参考书，只提炼写法，不搬角色、情节和设定。',
                input: '输入：两本参考书',
                process: '系统：按循环/卷批量拆技法，融合成原创细纲',
