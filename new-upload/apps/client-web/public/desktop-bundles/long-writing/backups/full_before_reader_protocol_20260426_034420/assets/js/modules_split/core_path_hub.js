...
var CorePathHub = {
    routes: {
        ...
        import: {
            label: '接着已有作品写',
            short: '导入续写',
            desc: '原文保留、章内细纲、实体规则伏笔、续写',
            plain: '已有正文不重写，按卷章拆细纲，再提实体进世界引擎。',
            icon: 'fa-file-import',
            color: 'cyan',
            entry: 'world_engine',
            steps: ['导入', '章内细纲', '图谱', '续写']
        ...
        fusion: {
            ...
            plain: '两本参考书只提技法，按循环/卷批处理，最后生成新细纲。',
    ...
    modules: {
        ...
        world_engine: {
            title: '世界引擎',
            role: '知识图谱与导入解析中枢',
            focus: '从零项目在这里沉淀实体关系；导入项目在这里拆原文细纲并保留正文。',
            next: '导入/入图谱',
            route: 'import'
        },
        fusion_book: {
            title: '融合拆书',
            role: '拆书融合入口',
            focus: '导入两本参考书，按循环/卷提取技法，融合成原创细纲，再送世界引擎和执笔台。',
            next: '开始循环融合',
            route: 'fusion'
        },
        fusion_workbench: {
