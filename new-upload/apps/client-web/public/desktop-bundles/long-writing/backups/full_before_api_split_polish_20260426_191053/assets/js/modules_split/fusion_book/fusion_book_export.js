...
只输出循环弹药包，严禁涉及原书的具体角色和情节。`;
        cycleFusionPrompt = this._withDirectionGuard ? this._withDirectionGuard(cycleFusionPrompt, '循环弹药') : cycleFusionPrompt;
