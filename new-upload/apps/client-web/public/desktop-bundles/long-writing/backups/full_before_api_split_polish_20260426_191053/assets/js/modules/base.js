...
Modules.home = {
    ...
    _pathProfile(mode) {
        ...
        const map = {
            ...
            import: {
                headline: '我要接着已有作品写',
                plain: '已有正文先保留，缺哪里补哪里，想自己写也可以。',
                input: '输入：已有正文/原稿',
                process: '系统：按章节细分，补细纲，提实体/规则/伏笔/关系',
                result: '产出：原文正文 + 续写细纲 + 图谱上下文',
                target: 'world_engine',
                targetLabel: '打开导入续写',
                steps: ['导入/手写', '拆章内细纲', '入图谱', '补续写']
            },
            fusion: {
                headline: '我要拆书融合出新书',
    ...
    _renderWorkflowDeck() {
        const cards = [
            ...
            ['continue_existing','world_engine','fa-file-import','导入续写融合','把没写完的原稿导入，保留正文，再接拆书技法续。','emerald'],
