...
const LocalSync = {
    ...
    ALL_STORES: ['volumes','chapters','outlines','writings','entities','vectors','rag_documents','prompts',
        'tools_custom','assets','library_books','text_api_pool','settings','chat_sessions','cycles','projects','project_snapshots'],

    // ★ 切换文件夹时不清空的 store (全局配置+项目元数据，不跟文件夹走)
    GLOBAL_STORES: ['text_api_pool','image_api_pool','video_api_pool','audio_api_pool','projects','project_snapshots'],
...
// ═══════════════════════════════════════════════════════════════
const DB = {
    name: 'GenesisDB', version: 13, db: null,
    _initPromise: null,
