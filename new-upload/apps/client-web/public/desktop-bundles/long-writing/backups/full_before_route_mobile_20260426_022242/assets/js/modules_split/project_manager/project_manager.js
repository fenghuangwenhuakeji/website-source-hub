...
Modules.project_manager = {
    ...
    _showCreateModal(preselectedMode = 'phoenix') {
        ...
        const modes = [
            ['phoenix','fa-fire-flame-curved','我要从零写一本','世界观、大纲、正文从头搭','orange'],
            ['import','fa-file-import','我要接着已有作品写','正文保留，拆纲入图谱后续写','cyan'],
            ['fusion','fa-code-compare','我要拆书融合出新书','双书提技法，融合成新故事','purple']
        ];
        overlay.innerHTML = `
    ...
    _pathProfile(mode) {
        const profiles = {
            phoenix: {
                headline: '从零写一本',
                plain: '从题材到细纲，再把实体注入世界引擎。',
                icon: 'fa-fire-flame-curved',
                color: 'orange'
            },
            import: {
                headline: '导入续写',
                plain: '已有正文保留，拆细纲、提实体、补续写。',
                icon: 'fa-file-import',
                color: 'cyan'
            },
            fusion: {
                headline: '拆书融合',
                plain: '两本参考书提技法，融合成新书。',
